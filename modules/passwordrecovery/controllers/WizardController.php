...
class WizardController extends Controller
{
    ...
    public function actionEmailVerification()
    {
        ...
        if (!empty($request->post('code')) && count($request->post('code')) > 11) {
            ...
            if (Yii::$app->session->get('emailCode') == VerificationCode::parseFromArray($request->post('code'))) {
    ...
    public function actionSmsVerification()
    {
        ...
        if (!empty($request->post('code')) && count($request->post('code')) > 11) {
            ...
            if (Yii::$app->session->get('smsCode') == VerificationCode::parseFromArray($request->post('code'))) {
    ...
    public function actionPassword()
    {
        ...
        if (!empty($request->post('NewPasswordForm'))) {
            ...
            if ($model->validate()) {
                ...
                IdbBusinessUser::changePassword($token['uid'], $model->password);
