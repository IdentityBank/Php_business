...
$this->title = Translate::_('business', 'Account Verification');
                            ...
                            <div class="sp-module-content">
                                <div>
                                    ...
                                    <h2><?= Translate::_(
                                        ...
                                        <br><br>
                                        <?= Translate::_('business', 'Enter the SMS and email codes below:') ?></h2>

                                    <?= $form->field($model, 'smsCode')->textInput(
                                        ['placeholder' => Translate::_('business', 'SMS Code'), 'id' => 'sms_field']
                                    ) ?>
                                    <?= $form->field($model, 'emailCode')->textInput(
                                        ['placeholder' => Translate::_('business', 'Email code'), 'id' => 'email_field']
                                    ) ?>
            ...
            <div class="row">
                <div class="col-lg-12" style="float: none;margin: 0 auto;">
                    <?= $wizardAsset->generateWizardActions(
                        [
                            'Text' => Translate::_('business', 'Complete account signup'),
                            'Action' => 'Submit',
