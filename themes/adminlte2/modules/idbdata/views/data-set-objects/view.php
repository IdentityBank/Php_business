...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <h1>
            <?= Html::encode(Translate::_('business', 'View data set object')) ?>
        </h1>
        <?= Breadcrumbs::widget(
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body">
                        ...
                        <div class="data-set-object-view">
                            ...
                            <div class="form-group">
                                ...
                                <?= Html::a(
                                    Translate::_('business', 'Admin Data Set Object'),
                                    ['index'],
                                    ['class' => 'btn btn-primary']
                                ) ?>
                                <?= Html::a(
                                    Translate::_('business', 'Create Data Set Object'),
                                    ['create'],
