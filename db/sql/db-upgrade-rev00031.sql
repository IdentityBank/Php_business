...
CREATE TYPE email_action_type AS ENUM ('BUSINESS_EMAIL_VERIFICATION', 'PEOPLE_EMAIL_VERIFICATION');

CREATE TYPE available_language AS ENUM ('pl_PL', 'nl_NL', 'fr_FR', 'de_DE', 'en_GB');
...
(
    ...
    "language" available_language NOT NULL
);
